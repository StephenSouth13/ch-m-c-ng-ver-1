    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Tháng 5/2023</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">176h 30m</div>
          <p className="text-xs text-muted-foreground">Tháng 5/2023</p>
        </CardContent>
      </Card>
      <Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Năm 2023</p>
        </CardContent>
      </Card>
    </div>
  )
